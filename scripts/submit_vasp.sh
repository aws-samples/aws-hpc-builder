...
export JOB_DIR=/fsx/spooler/06-opt_blind6_22_exp
...
source /fsx/scripts/env.sh 0 1 1
...
mpiexec -n ${NPROCS} ${HPC_PREFIX}/${HPC_COMPILER}/vasp.${VASP_VERSION}/bin/vasp_std >> mpiexe_${SARCH}_${HPC_COMPILER}.log 2>&1
